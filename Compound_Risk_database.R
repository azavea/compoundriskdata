...
write.csv(health_sheet, "data/processed/healthsheet.csv")
...
write.csv(food_sheet, "data/processed/foodsecuritysheet.csv")
...
write.csv(macro_sheet, "data/processed/macrosheet.csv")
...
write.csv(nathazard_sheet, "/data/processed/Naturalhazards.csv")
