...
# Load risk sheets
healthsheet <- read_risk_sheet("data/processed/healthsheet.csv", root)
foodsecurity <- read_risk_sheet("data/processed/foodsecuritysheet.csv", root)
# debtsheet <- read_risk_sheet("data/processed/debtsheet.csv", root)
fragilitysheet <- read_risk_sheet("data/processed/fragilitysheet.csv", root)
...
# Write as csv
write.csv(globalrisk, "data/processed/Global_compound_risk_database.csv")
...
write.csv(reliabilitysheet, "data/processed/reliabilitysheet.csv")
...
write.csv(riskflags, "data/processed/Compound_Risk_Flag_Sheets.csv")
}
